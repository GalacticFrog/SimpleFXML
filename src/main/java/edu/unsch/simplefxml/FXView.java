...
/**
 * The annotation indicates a class to be used in the context of an JavaFX view.
 * Such classes are used in combination with fxml markup files.
 *
...
public @interface FXView {
    ...
    /**
     * The style to be applied to the underlying stage when using this view as a
     * modal window.
     *
     * @return the style of the current stage
     */
