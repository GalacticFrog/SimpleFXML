 ...
 *
 * It is inspired from Adam Bien's afterburner.fx project
 ...
 * >FXView</a> that provides DI for Java FX Controllers via Spring.
 * </p>
 * <p>
...
public abstract class AbstractFxmlView implements ApplicationContextAware {
    ...
    private final FXView annotation;
     ...
     */
    private URL getURLResource(final FXView annotation) {
    ...
    /**
     * Gets the {@link FXView} annotation from inheriting class.
     *
     * @return the FXML annotation
     */
    private FXView getFXMLAnnotation() {
        final Class<? extends AbstractFxmlView> theClass = this.getClass();
        final FXView annotation = theClass.getAnnotation(FXView.class);
        return annotation;
    }
    ...
    /**
     * Shows the FxmlView instance being the child stage of the given
     * {@link Window}
     *
    ...
    /**
     * Shows the FxmlView instance being the child stage of the given
     * {@link Window} and waits to be closed before returning to the caller.
     *
     * @param window The owner of the FxmlView instance
     * @param modality See {@code javafx.stage.Modality}.
     */
    ...
    /**
     * Shows the FxmlView instance on a top level {@link Window} and waits to be
     ...
     * method omits the root container and gives you the access to its first
     * child.
     *
     * @return the first child of the view or null if there are no children
