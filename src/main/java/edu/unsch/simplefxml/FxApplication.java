...
public abstract class FxApplication extends Application {
    ...
    /**
     * Gets called after full initialization of Spring application context and
     * JavaFX platform right before the initial view is shown. Override this
     * method as a hook to add special code for your app. Especially meant to
    ...
    public Collection<Image> loadDefaultIcons() {
        return Arrays.asList(
                new Image(getClass().getResource("/icons/console_16x16.png").toExternalForm()),
                new Image(getClass().getResource("/icons/console_24x24.png").toExternalForm()),
                new Image(getClass().getResource("/icons/console_36x36.png").toExternalForm()),
                new Image(getClass().getResource("/icons/console_42x42.png").toExternalForm()),
                new Image(getClass().getResource("/icons/console_64x64.png").toExternalForm()));
    }
}
